...
from fitness.views import TrainerListView, TrainerDetailView,  TrainerSubscriptionListView, ExerciseItemUpdateView
...
urlpatterns = [
    ...
    path('trainee-updateexersize-item/<int:object_id>', ExerciseItemUpdateView.as_view(), name =' trainee-exersize'),
