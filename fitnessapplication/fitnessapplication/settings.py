"""
Django settings for fitnessapplication project.
...
SECRET_KEY = "django-insecure-y0i7_4e7n_ncd+rtg2_fba=ynj_4uhk@w1-v-x5-@f@ld+dx63"
...
WSGI_APPLICATION = "fitnessapplication.wsgi.application"
